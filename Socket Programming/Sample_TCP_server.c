...
int main(int argc, char**argv){
	...
	// initialize a sockaddr_in struct with our own addres information for binding the socket
	...
	connfd = accept(listenfd,(struct sockaddr *) &cliaddr, &clilen); // the uninitialized cliaddr variable is filled in with the information of the client by recvfrom function
